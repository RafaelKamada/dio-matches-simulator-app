...
import me.dio.simulator.ui.adapter.MatchesAdapterKotlin;
...
public class MainActivity extends AppCompatActivity {
    ...
    private MatchesAdapterKotlin matchesAdapter;
    ...
    private void setupHttpCliente() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://rafaelkamada.github.io/matches-simulator-api/")
        ...
        binding.fabSimulate.setOnClickListener( view -> {
            ...
            view.animate().rotationBy(360).setDuration(1000).setListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                   // view.animate().scaleY(1).scaleX(1).setDuration(500);
                    Random random = new Random();
                    for (int i = 0; i < matchesAdapter.getItemCount(); i++) {
                        Match match = matchesAdapter.getMatches().get(i);
                        match.getHomeTeam().setScore(random.nextInt(match.getHomeTeam().getStars() + 1));
                        match.getHomeAway().setScore(random.nextInt(match.getHomeAway().getStars() + 1));
